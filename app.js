document.getElementById("submit").addEventListener("click", function () {
    ...
    let fourthPrizeChage = randomNumber(61.20, 98.18);
    let fivePrizeChange = randomNumber(30.12, 70.13);
    let sixPrizeChange = randomNumber(52.35, 90.88);
   

    let subtotal = firstPrizeChange + secondPrizeChange + thirdPrizeChange + fourthPrizeChage + fivePrizeChange + sixPrizeChange;
